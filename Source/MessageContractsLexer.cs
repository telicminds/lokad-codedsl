...
// $ANTLR 3.4.1.9004 MessageContracts.g 2013-01-31 15:33:51
...
public partial class MessageContractsLexer : Antlr.Runtime.Lexer
{
    ...
    private void mANNOTATION()
    {
    	...
    	EnterRule("ANNOTATION", 26);
    	TraceIn("ANNOTATION", 26);
    		try
    		{
    		...
    		while (true)
    		{
    			...
    			if ((LA10_1==' '||LA10_1==','||(LA10_1>='0' && LA10_1<='9')||LA10_1=='<'||LA10_1=='>'||(LA10_1>='A' && LA10_1<='Z')||LA10_1=='_'||(LA10_1>='a' && LA10_1<='z')))
    			{
    				alt10 = 1;
    			}
    	...
    	{
    		TraceOut("ANNOTATION", 26);
    		LeaveRule("ANNOTATION", 26);
