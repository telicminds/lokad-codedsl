...
namespace Lokad.CodeDsl
{
    public sealed class TemplatedGenerator
    {
		...
		public string InterfaceMemberTemplate { get; set; }
		public string TemplateForEventInterfaceName { get; set; }
...
{{", contract.Name);
		...
		void WriteInterfaceMembers(Message message, CodeWriter writer)
		{
			...
			{
				writer.WriteLine(InterfaceMemberTemplate, member.Type, GeneratorUtil.MemberCase(member.Name));
			}
		}
